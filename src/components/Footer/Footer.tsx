    ...
    >
        ...
        <Flex flexWrap="wrap" alignItems="start" justify="space-between">
          ...
          >
            ...
            <List lineHeight="2">
              ...
              <LinkItem text="Privacy &amp; Security" />
              <LinkItem text="Supported Platforms" />
              <LinkItem text="IntelliSync+" isTag={true} tagText="New" />
            </List>
          </Box>
          <Box
            w={{ base: '100%', sm: '50%', md: 'max-content' }}
          ...
          >
            ...
            <List lineHeight="2">
              <LinkItem text="Why use IntelliSync" />
              <LinkItem text="Server Capacity" />
              <LinkItem text="Enterprise Support" />
      ...
      >
        ...
        <Text color="gray.600" fontSize="0.875rem" pl="0.5rem">
          {/* &copy; 2023 IntelliSync, Inc. All rights reserved. */}
          Demo Landing Page Project by github/soyunmate
        </Text>
      </Flex>
    </Box>
  )
